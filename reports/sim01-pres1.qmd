...
d_tbl <- data.table(
  ...
  spec = c(
    ...
    "Medically attended RSV-LRI: ascertained via review of notifications for laboratory-confirmed RSV infection to the NT Notifiable Disease System from time of randomisation to 12-months post randomisation date.",
