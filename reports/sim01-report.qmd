...
Within each region/locality combination we allocated intervention vs soc with a 1:1 ratio.
...
In practice, there may be different distributions for the log-odds of RSV-LRI based on locality status within each region, i.e. the shift in the log-odds of RSV-LRI associated with remote vs urban may be different for Alice and Darwin, but this has been ignored for now and no interactions are included in the data generation nor model.
