...
Each scenario adopts a maximum sample size of 1000 with interim analyses run after `r paste0(cumsum(l[[1]]$cfg$N)[-length(l[[1]]$cfg$N)], collapse = ", ")` enrolments have occurred, with only those that have reached their primary endpoint entering into the analyses.
